...
static const uint8_t *ascii_glyph_rows(char c) {
    ...
    static const uint8_t a_[FONT_H] = { 0x00, 0x00, 0x0e, 0x01, 0x0f, 0x11, 0x0f };
    static const uint8_t b_[FONT_H] = { 0x10, 0x10, 0x1e, 0x11, 0x11, 0x11, 0x1e };
    static const uint8_t c_[FONT_H] = { 0x00, 0x00, 0x0f, 0x10, 0x10, 0x10, 0x0f };
    static const uint8_t d_[FONT_H] = { 0x01, 0x01, 0x0f, 0x11, 0x11, 0x11, 0x0f };
    static const uint8_t e_[FONT_H] = { 0x00, 0x00, 0x0e, 0x11, 0x1f, 0x10, 0x0f };
    static const uint8_t f_[FONT_H] = { 0x06, 0x08, 0x08, 0x1c, 0x08, 0x08, 0x08 };
    static const uint8_t g_[FONT_H] = { 0x00, 0x00, 0x0f, 0x11, 0x0f, 0x01, 0x0e };
    static const uint8_t h_[FONT_H] = { 0x10, 0x10, 0x1e, 0x11, 0x11, 0x11, 0x11 };
    static const uint8_t i_[FONT_H] = { 0x04, 0x00, 0x0c, 0x04, 0x04, 0x04, 0x0e };
    static const uint8_t j_[FONT_H] = { 0x02, 0x00, 0x06, 0x02, 0x02, 0x12, 0x0c };
    static const uint8_t k_[FONT_H] = { 0x10, 0x10, 0x12, 0x14, 0x18, 0x14, 0x12 };
    static const uint8_t l_[FONT_H] = { 0x0c, 0x04, 0x04, 0x04, 0x04, 0x04, 0x0e };
    static const uint8_t m_[FONT_H] = { 0x00, 0x00, 0x1a, 0x15, 0x15, 0x15, 0x15 };
    static const uint8_t n_[FONT_H] = { 0x00, 0x00, 0x1e, 0x11, 0x11, 0x11, 0x11 };
    static const uint8_t o_[FONT_H] = { 0x00, 0x00, 0x0e, 0x11, 0x11, 0x11, 0x0e };
    static const uint8_t p_[FONT_H] = { 0x00, 0x00, 0x1e, 0x11, 0x1e, 0x10, 0x10 };
    static const uint8_t q_[FONT_H] = { 0x00, 0x00, 0x0f, 0x11, 0x0f, 0x01, 0x01 };
    static const uint8_t r_[FONT_H] = { 0x00, 0x00, 0x16, 0x18, 0x10, 0x10, 0x10 };
    static const uint8_t s_[FONT_H] = { 0x00, 0x00, 0x0f, 0x10, 0x0e, 0x01, 0x1e };
    static const uint8_t t_[FONT_H] = { 0x08, 0x08, 0x1c, 0x08, 0x08, 0x09, 0x06 };
    static const uint8_t u_[FONT_H] = { 0x00, 0x00, 0x11, 0x11, 0x11, 0x13, 0x0d };
    static const uint8_t v_[FONT_H] = { 0x00, 0x00, 0x11, 0x11, 0x11, 0x0a, 0x04 };
    static const uint8_t w_[FONT_H] = { 0x00, 0x00, 0x11, 0x11, 0x15, 0x15, 0x0a };
    static const uint8_t x_[FONT_H] = { 0x00, 0x00, 0x11, 0x0a, 0x04, 0x0a, 0x11 };
    static const uint8_t y_[FONT_H] = { 0x00, 0x00, 0x11, 0x11, 0x0f, 0x01, 0x0e };
    static const uint8_t z_[FONT_H] = { 0x00, 0x00, 0x1f, 0x02, 0x04, 0x08, 0x1f };
