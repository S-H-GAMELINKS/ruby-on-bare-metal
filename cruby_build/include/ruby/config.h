...
/* confdefs.h */
/* Modified for Ruby on Bare Metal (bare-metal x86_64 with musl libc) */
...
/* REMOVED: HAVE_LIBCRYPT - no crypt library */
/* REMOVED: HAVE_LIBDL - no dlopen support */
...
/* REMOVED: HAVE_MALLOC_H - musl doesn't have this header */
#define HAVE_PWD_H 1
/* REMOVED: HAVE_SANITIZER_ASAN_INTERFACE_H - no sanitizer support */
/* REMOVED: HAVE_SANITIZER_TSAN_INTERFACE_H - no sanitizer support */
#define HAVE_STDALIGN_H 1
#define HAVE_STDIO_H 1
/* REMOVED: HAVE_SYS_EVENTFD_H - no eventfd support */
...
/* REMOVED: HAVE_SYS_SOCKET_H - no socket support */
#define HAVE_SYS_SYSCALL_H 1
/* REMOVED: HAVE_SYS_SYSMACROS_H */
#define HAVE_SYS_TIME_H 1
#define HAVE_SYS_TIMES_H 1
#define HAVE_SYS_UIO_H 1
#define HAVE_SYSCALL_H 1
#define HAVE_TIME_H 1
/* REMOVED: HAVE_UCONTEXT_H - no ucontext support */
#define HAVE_UTIME_H 1
/* REMOVED: HAVE_SYS_EPOLL_H - no epoll support */
#define HAVE_STDATOMIC_H 1
/* REMOVED: HAVE_X86INTRIN_H (both occurrences) */
...
/* CHANGED: FUNC_UNOPTIMIZED/FUNC_MINIMIZED - clang doesn't support __optimize__ */
...
/* REMOVED: HAVE_STRUCT_STATX_STX_BTIME - no statx support */
...
/* REMOVED: STACK_END_ADDRESS - Ruby on Bare Metal handles stack ourselves */
...
#define HAVE_ACOSH 1
#define HAVE_CBRT 1
/* REMOVED: HAVE_CRYPT - no crypt support */
#define HAVE_ERF 1
...
/* REMOVED: SPT_TYPE SPT_REUSEARGV */
#define HAVE_SIGNBIT 1
/* REMOVED: HAVE_FORK, HAVE_VFORK, HAVE_WORKING_VFORK, HAVE_WORKING_FORK */
#define HAVE__LONGJMP 1
/* REMOVED: HAVE_ARC4RANDOM_BUF */
...
/* REMOVED: HAVE_COPY_FILE_RANGE - no copy_file_range support */
#define HAVE_COSH 1
/* REMOVED: HAVE_CRYPT_R - no crypt support */
#define HAVE_DIRFD 1
/* REMOVED: HAVE_DL_ITERATE_PHDR - no dlopen support */
/* REMOVED: HAVE_DLOPEN - no dlopen support */
/* REMOVED: HAVE_DLADDR - no dlopen support */
#define HAVE_DUP3 1
#define HAVE_EACCESS 1
#define HAVE_ENDGRENT 1
/* REMOVED: HAVE_EVENTFD - no eventfd support */
#define HAVE_EXECL 1
...
/* REMOVED: HAVE_GETENTROPY */
#define HAVE_GETEUID 1
#define HAVE_GETGID 1
#define HAVE_GETGRNAM 1
#define HAVE_GETGRNAM_R 1
#define HAVE_GETGROUPS 1
/* REMOVED: HAVE_GETLOGIN, HAVE_GETLOGIN_R */
...
/* REMOVED: HAVE_MALLOC_TRIM - not available in musl */
#define HAVE_MBLEN 1
...
/* REMOVED: HAVE_PCLOSE - no popen/pclose support */
#define HAVE_PIPE 1
#define HAVE_PIPE2 1
#define HAVE_POLL 1
/* REMOVED: HAVE_POPEN - no popen/pclose support */
...
#define HAVE_ROUND 1
/* REMOVED: HAVE_SCHED_GETAFFINITY */
...
/* REMOVED: HAVE_SHUTDOWN - no socket support */
...
/* REMOVED: HAVE_SYSTEM - no system() support */
#define HAVE_TANH 1
...
/* REMOVED: HAVE_STATX - no statx support */
/* REMOVED: HAVE_CRYPT_H - no crypt support */
/* REMOVED: HAVE_STRUCT_CRYPT_DATA_INITIALIZED - no crypt support */
...
/* REMOVED: HAVE_LIBRT (both occurrences) */
/* REMOVED: HAVE_TIMER_CREATE, HAVE_TIMER_SETTIME */
...
/* REMOVED: HAVE_GETCONTEXT, HAVE_SETCONTEXT - no ucontext support */
/* REMOVED: HAVE_SYS_USER_H - no ELF/debug support */
#define HAVE_CONST_PAGE_SIZE 0
#define IOCTL_REQ_TYPE unsigned long
#define NUM2IOCTLREQ(num) NUM2ULONG(num)
/* REMOVED: USE_ELF, HAVE_ELF_H - bare metal, no ELF loader */
/* REMOVED: HAVE_LIBZ - no zlib */
/* REMOVED: HAVE_BACKTRACE - no backtrace support */
/* REMOVED: DLEXT_MAXLEN, DLEXT, SOEXT - no dynamic loading */
#define HAVE__SETJMP 1
/* CHANGED: Use _setjmp/_longjmp for compatibility (not __builtin versions) */
#include <setjmp.h>
...
#define USE_YJIT 0
#define USE_ZJIT 0
/* CHANGED: Platform identifier for Ruby on Bare Metal */
#define RUBY_PLATFORM "x86_64-ruby-on-bare-metal"
